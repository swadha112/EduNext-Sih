        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Chatbot --> */}
              <SidebarLinkGroup activeCondition={pathname === '/chatbot'}>
                {(handleClick, open) => {
                  return (
                    <NavLink
                      to="/chatbot"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                        pathname === '/chatbot' && 'bg-graydark dark:bg-meta-4'
                      }`}
                    >
                      <svg
                        className="fill-current"
              ...
              <SidebarLinkGroup activeCondition={pathname === '/workshop'}>
                {(handleClick, open) => {
                  return (
                    <NavLink
                      to="/workshop"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                        pathname === '/workshop' && 'bg-graydark dark:bg-meta-4'
                      }`}
                    >
                      <svg
                        className="fill-current"
                      ...
                      >
                        <path
                          d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm1-13h-2v6h6v-2h-4z"
                          fill="currentColor"
                        />
                      </svg>
                      Nearby Workshops
              ...
              <li>
                ...
                >
                  <svg
                    fill="currentColor" // Use currentColor to inherit the parent element's color
                    height="18" // Adjust to fit your size
                    width="18" // Adjust to fit your size
                  ...
                  >
                    <g>
                      <g>
                        <g>
                          <path
                            d="M469.413,349.114l-31.938-223.211c-2.786-19.467-12.513-37.35-27.387-50.355c-15.022-13.134-34.296-20.367-54.271-20.367
